        ...
        <div className="logo-container">
            ...
            <div className="nav-items">
                ...
                <div className="icons">
                    ...
                    <a target="_blank" rel="noreferrer" href="https://www.facebook.com/medieteknikdagen" className="icon-link"><FontAwesomeIcon className="brand-icons" icon={faFacebook}/></a>
                    <a target="_blank" rel="noreferrer" href="https://www.instagram.com/medieteknikdagen/" className="icon-link"><FontAwesomeIcon className="brand-icons" icon={faInstagram}/></a>
